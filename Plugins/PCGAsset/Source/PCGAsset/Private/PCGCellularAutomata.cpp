...
- The ID generated by my method in PCG is weird. It's a bunch of point with density 1 append at the end of a density 0
- The ID should start from left to right not random
